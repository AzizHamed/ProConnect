 ...
 * @param url URL mapping for the required API endpoint. For example, users/getUser
 ...
 * @param url URL mapping for the required API endpoint. For example, users/updateUser
